...
<span style='font-weight: 700; font-size: 0.95rem;'>{dcf_status}</span>
        ...
        if current_logic == "Quant":
            ...
            # ✅ MPT 自動判讀上方點選的 "多空情境"，進行神經連動目標波動率計算
            ...
            if len(port_df) > 0:
                ...
                # ✅ 波動率目標控制 (Volatility Targeting 演算法)
                ...
                with c2:
                    ...
                    <div style='background-color:#1E293B; padding:15px; border-radius:4px; border:1px solid #334155;'>
                        ...
                        <div style='font-size:0.8rem; color:#64748B; margin-bottom:12px;'>* 已啟用 Volatility Targeting 縮放曝險權重</div>
                        <div style='display:flex; justify-content:space-between; margin-bottom:8px;'>
